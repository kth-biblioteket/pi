...
<h2>VISA REGLER CENTRA UTAN TRÄFF</h2>
...
<?php
    ...
    $sql = "SELECT r.R_c_m_id,r.Find_country,r.Find_city,r.Find_org,r.Divide,r.Country_1,r.City_1,r.Org_id_1,
    ...
    FROM Rule_center_match r WHERE NOT EXISTS (SELECT * FROM Unified_address ua WHERE ua.R_c_m_id = r.R_c_m_id)";
