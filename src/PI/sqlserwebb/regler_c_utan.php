...
try {
    $countStmt = $dbh->query("SELECT COUNT(*) FROM Rule_center_match r WHERE $whereSql");
    ...
    <! Syfte: Adressrättnings-hantering>
        <! Ändringar:>
            ...
            <head>
                ...
                <title>Visa regler centra utan träff</title>
                    ...
                    <section class="bibmet-hero">
                        <div class="bibmet-hero__row">
                            <div>
                                ...
                                <h1 class="bibmet-title">Visa regler centra utan träff</h1>
                                <p class="bibmet-muted">Visar centrumregler som saknar träff i adressrättningen.</p>
                            </div>
                                    ...
                                    <?php if (!$rows) : ?>
                                        <tr>
                                            <td colspan="<?php echo h(count($columns) + 1); ?>" class="bibmet-empty">
                                                Inga centrumregler saknar träff.
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                        ...
                                        <tr>
                                            <td class="bibmet-table__actions">
                                                <div class="bibmet-table__action-row">
                                                    <a
                                                        href="aendra_regel_c.php?Regel_id=<?php echo h($row["R_c_m_id"]); ?>"
                                                        class="bibmet-button bibmet-button--primary bibmet-button--small">
                                                        Ändra
                                                    </a>
                                                    <a
                                                        href="ta_bort_regel_c.php?Regel_id=<?php echo h($row["R_c_m_id"]); ?>"
