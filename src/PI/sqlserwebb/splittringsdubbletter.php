...
try {
    $countStmt = $dbh->query("SELECT COUNT(*) FROM Rule_org_match WHERE Find_sub_org = 'D'");
    ...
    $errors[] = "Det gick inte att hämta splittringsdubbletter. " . $e->getMessage();
}
                    ...
                    <section class="bibmet-hero">
                        <div class="bibmet-hero__row">
                            <div>
                                ...
                                <h1 class="bibmet-title">Regler som ger splittringsdubbletter</h1>
                                <p class="bibmet-muted">
                                    Visar organisationsregler där underorganisation markeras som splittringsdubblett.
                                </p>
                            </div>
                            <a
                                    ...
                                    <?php if (!$rows) : ?>
                                        <tr>
                                            <td colspan="<?php echo h(count($columns) + 1); ?>" class="bibmet-empty">
                                                Inga regler som ger splittringsdubbletter hittades.
                                            </td>
                                        </tr>
                                    <?php endif; ?>
