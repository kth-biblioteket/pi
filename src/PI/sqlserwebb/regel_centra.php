...
<body class="bibmet-body" onload="f_Ladda_sida()">
    ...
    <main class="bibmet-main bibmet-main--form">
        <section class="bibmet-hero">
            <div class="bibmet-hero__row">
                <div>
                    ...
                    <h1 class="bibmet-title">Regler centra</h1>
                    <p class="bibmet-muted">Sök, skapa och granska regler för centrummatchning.</p>
                </div>
        ...
        <form action="visa_regler_c.php" method="post" class="bibmet-panel">
            <div class="bibmet-panel__header">
                <h2 class="bibmet-panel__title">Sökurval</h2>
                <p class="bibmet-muted">Ange ett eller flera fält för att hitta centrumregler.</p>
            </div>
            ...
            <div class="bibmet-form-grid">
                ...
                <label class="bibmet-field">
                    <span class="bibmet-field__label">Organisation</span>
                    <input type="text" name="Org" class="bibmet-input">
                </label>
            </div>
            ...
            <div class="bibmet-form-actions">
                ...
                <div class="bibmet-action-group">
                    <button type="submit" formaction="ny_regel_c.php" name="test" class="bibmet-button bibmet-button--secondary">Ny regel</button>
                    <button type="submit" formaction="regler_c_utan.php" name="utan" class="bibmet-button bibmet-button--secondary">Regel utan träff</button>
                </div>
            </div>
        </form>
    </main>
