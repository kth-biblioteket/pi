...
<?php
    ...
    if (strlen($Aemne) >= 3  and strlen($Titel) > 10 ) {
       ...
       $SoekTitel = $Titel;
       $SoekTitel = str_replace($Sk_1, $Ers_a, $SoekTitel);
       $SoekTitel = str_replace($Sk_2, $Ers_b, $SoekTitel);
       $SoekTitel = str_replace($Sk_3, $Ers_b, $SoekTitel);
       $SoekTitel = str_replace($Sk_4, $Ers_b, $SoekTitel);
       $SoekTitel = str_replace($Sk_5, $Ers_b, $SoekTitel);
