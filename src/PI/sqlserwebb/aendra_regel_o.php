...
<?php
    ...
    if (intval($regel_id) > 0) {
    	...
    	foreach ($stmt as $row) {
            ...
            $stad_h_1 = $row['City_1'];
            $stad_h_1_2 = $row['City_1'];            
            $stad_h_2 = $row['City_2'];
            $stad_h_2_2 = $row['City_2'];            
            $stad_h_3 = $row['City_3'];
            $stad_h_3_2 = $row['City_3'];            
            $org_s = $row['Find_org'];
...
<h2>ÄNDRA REGEL ORGANISATION</h2>	
		    ...
		    <form action="aendra_regel_resultat_o.php" method="post">
                ...
                <input type="submit" formaction="koer_regel_o.php" name="koer" value="Provkör regel"/>&nbsp;&nbsp;
                ...
                Land #:</br>
                <input type="text" name="Land_ut" value="<?php echo $land_s; ?>" style="background-color:grey;color:white;border:0" size="40" />&nbsp;&nbsp;
                <input type="text" name="Land_ut_2" id="id_soek_land_s_2" value="<?php echo $land_s_2; ?>" style="background-color:green;color:white;border:0" size="40" />&nbsp;&nbsp;                
                <select id="id_s_land" name="Land_till" onchange="f_S_Land()">
                    <option>Ange land</option>
                </select>
                &nbsp;<input type="text" name="Soek_land_s" id="id_soek_land_s" onchange="f_populera_soek_Land_S()" size="40" />
                <br />
			    Stad:</br> 
				<input type="text" name="Stad_ut" value="<?php echo $stad_s; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
				<input type="text" name="Stad_nu" value="<?php echo $stad_s; ?>" hidden />
				<input type="text" name="Stad_till" id="id_s_stad" value="<?php echo $stad_s; ?>" style="background-color:green;color:white;border:0" size="40" />
                <br />
			    Organisationsnamn #:</br> 
				<input type="text" name="Org_ut" value="<?php echo $org_s; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp; 
			    <input type="text" name="Org_nu" value="<?php echo $org_s; ?>" hidden /> 
				<input type="text" name="Org_till" id="id_s_org" value="<?php echo $org_s; ?>" style="background-color:green;color:white;border:0" size="40" />
                <br />
				
				<h3>ÄNDRINGSFÄLT</h3>

			    Delas i #:</br>
				<input type="text" name="Delas_ut" value="<?php echo $delas; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
				<input type="text" name="Delas_ut_2" id="id_delas_h_2" value="<?php echo $delas_2; ?>" style="background-color:green;color:white;border:0" readonly="readonly" size="40" />&nbsp;&nbsp;				
                ...
                <input type="text" name="Org_1_ut" value="<?php echo $org_h_1; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
                <input type="text" name="Org_1_ut_2" id="id_org_h_1_2" value="<?php echo $org_h_1_2; ?>" style="background-color:green;color:white;border:0" size="40" />&nbsp;&nbsp;                
                ...
                <br />
			    Annat land:<br />
                <input type="text" name="Land_1_ut" value="<?php echo $land_h_1; ?>" style="background-color:grey;color:white;border:0" disabled size="40"/>&nbsp;&nbsp;
                <input type="text" name="Land_1_ut_2" id="id_soek_land_h_1_2" value="<?php echo $land_h_1_2; ?>" style="background-color:green;color:white;border:0" size="40"/>&nbsp;&nbsp;                
                ...
                <br />                								
				Annan stad:<br /> 
				<input type="text" name="Stad_1_ut" value="<?php echo $stad_h_1; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
				<input type="text" name="Stad_1_nu" value="<?php echo $stad_h_1; ?>" hidden />
				<input type="text" name="Stad_1_till" id="h_id_stad_1" value="<?php echo $stad_h_1; ?>" style="background-color:green;color:white;border:0" size="40"/>
                <br />
				<br />
						
				<b>Organisation 2:</b><br />
				Annat organisationsnamn:<br />
                <input type="text" name="Org_2_ut" value="<?php echo $org_h_2; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
                <input type="text" name="Org_2_ut_2" id="id_org_h_2_2" value="<?php echo $org_h_2_2; ?>" style="background-color:green;color:white;border:0" size="40" />&nbsp;&nbsp;                
                ...
                <br />
			    Annat land:<br />
                <input type="text" name="Land_2_ut" value="<?php echo $land_h_2; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
                <input type="text" name="Land_2_ut_2" id="id_soek_land_h_2_2" value="<?php echo $land_h_2_2; ?>" style="background-color:green;color:white;border:0" size="40" />&nbsp;&nbsp;                
				...
				<br />
				Annan stad:<br /> 
				<input type="text" name="Stad_2_ut" value="<?php echo $stad_h_2; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
				<input type="text" name="Stad_2_nu" value="<?php echo $stad_h_2; ?>" hidden />
				<input type="text" name="Stad_2_till" id="h_id_stad_2" value="<?php echo $stad_h_2; ?>" style="background-color:green;color:white;border:0" size="40" />
                <br />
				<br />
				
				<b>Organisation 3:</b><br />
				Annat organisationsnamn:<br />
                <input type="text" name="Org_3_ut" value="<?php echo $org_h_3; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
                <input type="text" name="Org_3_ut_2" id="id_org_h_3_2" value="<?php echo $org_h_3_2; ?>" style="background-color:green;color:white;border:0" size="40" />&nbsp;&nbsp;                
                ...
                <br />
			    Annat land:<br />
                <input type="text" name="Land_3_ut" value="<?php echo $land_h_3; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
                <input type="text" name="Land_3_ut_2" id="id_soek_land_h_3_2" value="<?php echo $land_h_3_2; ?>" style="background-color:green;color:white;border:0" size="40" />&nbsp;&nbsp;                
                ...
                &nbsp;<input type="text" name="Soek_land_h_3" id="id_soek_land_h_3" onchange="f_populera_soek_Land_H_3()" size="40" />				
				<br />
				Annan stad:<br /> 
				<input type="text" name="Stad_3_ut" value="<?php echo $stad_h_3; ?>" style="background-color:grey;color:white;border:0" disabled size="40" />&nbsp;&nbsp;
				<input type="text" name="Stad_3_nu" value="<?php echo $stad_h_3; ?>" hidden />
				<input type="text" name="Stad_3_till" id="h_id_stad_3" value="<?php echo $stad_h_3; ?>" style="background-color:green;color:white;border:0" size="40" />
                <br />
				<br />				
