...
elseif (strlen($str_1_till) == 0) { $alerts[] = 'Söksträng 1 måste anges som sökfält!'; }
elseif ($org_1_till == 'Ange organisation') { $alerts[] = 'Organisation 1 måste anges som ändringsfält!'; }
elseif ($delas_till == 1) {
...
if ($koll_svar && $a_regel_f_a_id !== $regel_id) {
    try {
        ...
        $sql = "UPDATE Rule_full_address_match SET Find_country = :find_country, Country_code = :country_code, Find_city = :find_city,
            Find_str_1 = :find_str_1, Find_str_2 = :find_str_2, Find_str_3 = :find_str_3,
            Find_str_not_1 = :find_str_not_1, Find_str_not_2 = :find_str_not_2, Divide = :divide,
            Country_1 = :country_1, City_1 = :city_1, Org_id_1 = :org_id_1,
            Country_2 = :country_2, City_2 = :city_2, Org_id_2 = :org_id_2,
            Country_3 = :country_3, City_3 = :city_3, Org_id_3 = :org_id_3,
        ...
        if ($stmt->rowCount() > 0) { $alerts[] = 'Regeln är nu ändrad!'; $_SESSION['a_regel_f_a_id'] = $regel_id; }
