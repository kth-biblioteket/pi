...
try {
    ...
    $errors[] = 'Det gick inte att provköra organisationsregeln.';
}
...
<head>
    ...
    <title>Funna adresser - organisationsregler</title>
        ...
        <section class="bibmet-hero">
            <div class="bibmet-hero__row">
                <div>
                    ...
                    <h1 class="bibmet-title">Funna adresser - organisationsregler</h1>
                ...
                <div class="bibmet-action-group">
                    ...
                    <?php if ($regelId !== '' && ctype_digit($regelId)) : ?>
                        <a href="aendra_regel_o.php?Regel_id=<?php echo bibmet_h($regelId); ?>" class="bibmet-button bibmet-button--secondary">Till ändra regel</a>
                    <?php endif; ?>
            ...
            <section class="bibmet-panel">
                ...
                <div class="bibmet-panel__body">
                    <p class="bibmet-muted" style="margin-top: 0;">
                        Den här sidan används för att provköra en organisationsregel. Gå till sökningen, hitta regeln, klicka på <strong>Ändra</strong> och välj sedan <strong>Provkör regel</strong> på ändra-sidan.
                    </p>
                    <div class="bibmet-action-group" style="margin-top: 16px;">
                        <a href="regel_organisation.php" class="bibmet-button bibmet-button--primary">Sök organisationsregler och välj Ändra</a>
                        <a href="adressmeny.php" class="bibmet-button bibmet-button--secondary">Till menyn</a>
                    </div>
                </div>
            </section>
