        ...
        if (!$rule) {
            ...
            try {
                $archiveSql = "INSERT INTO Removed_rules (
                    R_f_a_m_id, Find_country, Country_code, Find_city, Find_str_1, Find_str_2, Find_str_3,
                    Find_str_not_1, Find_str_not_2, Divide,
            ...
            $deleteStmt = $dbh->prepare("DELETE FROM rule_full_address_match WHERE R_f_a_m_id = :regel_id");
    ...
    <main class="bibmet-main">
        ...
        if ($ruleSummary) {
            bibmet_render_summary_panel("Regel", [
                "Regel-id" => $ruleSummary['R_f_a_m_id'] ?? null,
                "Land" => $ruleSummary['Find_country'] ?? null,
                "Stad" => $ruleSummary['Find_city'] ?? null,
                "Adress/sträng 1" => $ruleSummary['Find_str_1'] ?? null,
                "Adress/sträng 2" => $ruleSummary['Find_str_2'] ?? null,
                "Adress/sträng 3" => $ruleSummary['Find_str_3'] ?? null,
                "Ej sträng 1" => $ruleSummary['Find_str_not_1'] ?? null,
                "Ej sträng 2" => $ruleSummary['Find_str_not_2'] ?? null,
