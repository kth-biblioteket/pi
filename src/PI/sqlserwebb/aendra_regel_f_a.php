...
<?php
    ...
    if (intval($regel_id) > 0) {
    	...
    	$sql = "SELECT r.Find_country,r.Find_city,r.Find_str_1,r.Find_str_2,r.Find_str_3,r.Find_str_not_1,r.Find_str_not_2,r.Divide,
    	...
    	foreach ($stmt as $row) {
            ...
            $stad_h_2 = $row['City_2'];
            $stad_h_3 = $row['City_3'];
            $str_1 = $row['Find_str_1'];
            $str_2 = $row['Find_str_2'];
            $str_3 = $row['Find_str_3'];
            $str_1_ej = $row['Find_str_not_1'];
            $str_2_ej = $row['Find_str_not_2'];
...
<h2>ÄNDRA REGEL FULL ADRESS</h2>	
		    ...
		    <form action="aendra_regel_resultat_f_a.php" method="post">
                ...
                <br />
			    Söksträng 1 #:</br> 
				<input type="text" name="Str_1_ut" value="<?php echo $str_1; ?>" style="background-color:grey;color:white;border:0" disabled />&nbsp;&nbsp; 
			        <input type="text" name="Str_1_nu" value="<?php echo $str_1; ?>" hidden /> 
				<input type="text" name="Str_1_till" id="id_s_1" value="<?php echo $str_1; ?>" style="background-color:green;color:white;border:0"/>
                <br />
			    Söksträng 2:</br> 
				<input type="text" name="Str_2_ut" value="<?php echo $str_2; ?>" style="background-color:grey;color:white;border:0" disabled />&nbsp;&nbsp; 
			        <input type="text" name="Str_2_nu" value="<?php echo $str_2; ?>" hidden /> 
				<input type="text" name="Str_2_till" id="id_s_2" value="<?php echo $str_2; ?>" style="background-color:green;color:white;border:0"/>
                <br />
			    Söksträng 3:</br> 
				<input type="text" name="Str_3_ut" value="<?php echo $str_3; ?>" style="background-color:grey;color:white;border:0" disabled />&nbsp;&nbsp; 
			        <input type="text" name="Str_3_nu" value="<?php echo $str_3; ?>" hidden /> 
				<input type="text" name="Str_3_till" id="id_s_3" value="<?php echo $str_3; ?>" style="background-color:green;color:white;border:0"/>
                <br />
			    Söksträng ej 1:</br> 
				<input type="text" name="Str_ej_1_ut" value="<?php echo $str_1_ej; ?>" style="background-color:grey;color:white;border:0" disabled />&nbsp;&nbsp; 
			        <input type="text" name="Str_ej_1_nu" value="<?php echo $str_1_ej; ?>" hidden /> 
				<input type="text" name="Str_ej_1_till" id="id_s_ej_1" value="<?php echo $str_1_ej; ?>" style="background-color:green;color:white;border:0"/>
                <br />
			    Söksträng ej 2:</br> 
				<input type="text" name="Str_ej_2_ut" value="<?php echo $str_2_ej; ?>" style="background-color:grey;color:white;border:0" disabled />&nbsp;&nbsp; 
			        <input type="text" name="Str_ej_2_nu" value="<?php echo $str_2_ej; ?>" hidden /> 
				<input type="text" name="Str_ej_2_till" id="id_s_ej_2" value="<?php echo $str_2_ej; ?>" style="background-color:green;color:white;border:0"/>
                <br />
                ...
                <input type="text" name="Land_3_ut_2" id="id_soek_land_h_3_2" value="<?php echo $land_h_3_2; ?>" style="background-color:green;color:white;border:0" />&nbsp;&nbsp;                 
