...
<h2>TA BORT REGEL CENTRA</h2>	
		    ...
		    <form action="ta_bort_regel_resultat_c.php" onsubmit="return validateForm()" name="taBort" method="post">
				...
				<input type="text" name="Organisation" id="id_s_org" value="<?php echo $org_s; ?>" disabled /><br />
