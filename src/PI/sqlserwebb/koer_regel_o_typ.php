...
$org = bibmet_request_value('Org_nu', bibmet_request_value('Org_nu_1'));
...
if (($land === '' || $org === '') && $regelId !== '' && ctype_digit($regelId)) {
    try {
        $ruleStmt = $dbh->prepare('
            SELECT Find_country, Find_city, Find_org_1
            FROM Rule_org_type_match
            WHERE R_o_t_m_id = :regelId
        ');
        ...
        if ($rule) {
            ...
            $org = $org !== '' ? $org : trim((string) ($rule['Find_org_1'] ?? ''));
        }
...
try {
    ...
    $errors[] = 'Det gick inte att provköra organisationstypsregeln.';
}
        ...
        <section class="bibmet-hero">
            <div class="bibmet-hero__row">
                <div>
                    ...
                    <h1 class="bibmet-title">Funna adresser - regler organisationstyp</h1>
                ...
                <div class="bibmet-action-group">
                    ...
                    <?php if ($regelId !== '' && ctype_digit($regelId)) : ?>
                        <a href="aendra_regel_o_typ.php?Regel_id=<?php echo bibmet_h($regelId); ?>" class="bibmet-button bibmet-button--secondary">Till ändra regel</a>
                        <a href="traeff_regler_o_typ.php?Regel_id=<?php echo bibmet_h($regelId); ?>" class="bibmet-button bibmet-button--secondary">Visa regelträffar</a>
                    <?php endif; ?>
            ...
            <section class="bibmet-panel">
                ...
                <div class="bibmet-panel__body">
                    <p class="bibmet-muted" style="margin-top: 0;">
                        Den här sidan används för att provköra en organisationstypsregel. Gå till sökningen, hitta regeln, klicka på <strong>Ändra</strong> och välj sedan <strong>Regelträffar</strong> på ändra-sidan.
                    </p>
                    <div class="bibmet-action-group" style="margin-top: 16px;">
                        <a href="regel_organisation_typ.php" class="bibmet-button bibmet-button--primary">Sök organisationstypsregler och välj Ändra</a>
                        <a href="adressmeny.php" class="bibmet-button bibmet-button--secondary">Till menyn</a>
                    </div>
                </div>
            </section>
