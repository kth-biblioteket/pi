...
<h2>REGLER ORGANISATION</h2>

<form action="visa_regler_o.php" method="post">

<input type="submit" name="soek" value="Sök regel"/>&nbsp;&nbsp;
<input type="submit" formaction="ny_regel_o.php" name="ny" value="Ny regel"/>&nbsp;&nbsp;
<input type="submit" formaction="regler_o_utan.php" name="utan" value="Regel utan träff"/>&nbsp;&nbsp;
<input type="submit" formaction="splittringsdubbletter.php" name="splittra" value="Dubblettsplittrande regler"/>&nbsp;&nbsp;
...
&nbsp;<input type="text" name="Soek_land_s" id="id_soek_land_s" size="20" onchange="f_populera_soek_Land_S()"/>
<br /><br />
Stad: <br />
