...
<head>
    ...
    <title>Regler organisation</title>
...
<body class="bibmet-body">
    ...
    <main class="bibmet-main bibmet-main--form">
        <section class="bibmet-hero">
            <div class="bibmet-hero__row">
                <div>
                    ...
                    <h1 class="bibmet-title">Regler organisation</h1>
                    <p class="bibmet-muted">
                        Sök, skapa och granska regler för organisationsmatchning.
                    </p>
                </div>
                <a
                    href="adressmeny.php"
                    class="bibmet-button bibmet-button--secondary">
                    Till menyn
                </a>
            </div>
        </section>
        ...
        <form action="visa_regler_o.php" method="get" class="bibmet-panel">
            <div class="bibmet-panel__header">
                <h2 class="bibmet-panel__title">Sökurval</h2>
                <p class="bibmet-muted">Ange ett eller flera fält för att hitta organisationsregler.</p>
            </div>
            ...
            <div class="bibmet-form-grid">
                ...
                <label class="bibmet-field">
                    ...
                    <select
                        id="id_s_land"
                        name="Land"
                        class="bibmet-select js-bibmet-select">
            ...
            <div class="bibmet-form-actions">
                ...
                <div class="bibmet-action-group">
                    ...
                    <button
                        type="submit"
                        formaction="splittringsdubbletter.php"
                        name="splittra"
                        class="bibmet-button bibmet-button--secondary">
                        Dubblettsplittrande regler
                    </button>
                </div>
            </div>
        </form>
