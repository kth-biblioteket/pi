...
$orgStr1 = request_value("Org_str_1");
$orgStr2 = request_value("Org_str_2");
$orgStr3 = request_value("Org_str_3");
$orgStrNot1 = request_value("Org_str_not_1");
$orgStrNot2 = request_value("Org_str_not_2");
