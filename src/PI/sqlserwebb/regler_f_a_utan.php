...
$whereSql = "NOT EXISTS (
    ...
    WHERE ua.R_f_a_m_id = r.R_f_a_m_id
)";
                    ...
                    <section class="bibmet-hero">
                        <div class="bibmet-hero__row">
                            <div>
                                ...
                                <h1 class="bibmet-title">Visa regler full adress utan träff</h1>
                                <p class="bibmet-muted">Visar fulladressregler som saknar träff i adressrättningen.</p>
                            </div>
                                        ...
                                        <tr>
                                            <td class="bibmet-table__actions">
                                                <div class="bibmet-table__action-row">
                                                    <a
                                                        href="aendra_regel_f_a.php?Regel_id=<?php echo h($row["R_f_a_m_id"]); ?>"
                                                        class="bibmet-button bibmet-button--primary bibmet-button--small">
                                                        Ändra
                                                    </a>
                                                    <a
                                                        href="ta_bort_regel_f_a.php?Regel_id=<?php echo h($row["R_f_a_m_id"]); ?>"
